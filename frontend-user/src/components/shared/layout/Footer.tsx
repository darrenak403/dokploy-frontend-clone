...
export const Footer = () => {
  return (
    <footer className=" bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-gray-700 text-gray-800 dark:text-white border-t py-10">
            ...
            <div className="max-w-md">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1"
                  classNames={{
                    input: "bg-white text-black dark:bg-white dark:text-black",
                    inputWrapper:
