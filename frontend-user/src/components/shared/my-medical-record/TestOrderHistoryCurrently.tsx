...
const TestOrderHistoryCurrently: React.FC<TestOrderProps> = ({
  ...
  return (
    <div className="grid md:grid-cols-2 gap-4">
      {/* Recent blood test */}
      <div className="p-4 rounded-lg border border-gray-200 bg-white shadow-none hover:shadow-lg transform hover:scale-[1.01] origin-center transition-all duration-500 ease-in-out">
        ...
        {isAccessionNumber(accessionNumber) ? (
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between py-1">
              <span className="text-sm text-gray-500">Loại xét nghiệm</span>
            ...
            {instrument && (
              <div className="flex items-center justify-between py-1 border-t border-gray-100">
                <span className="text-sm text-gray-500">Thiết bị sử dụng</span>
                <span className="text-sm font-medium text-gray-900">
                  {instrument}
                </span>
              </div>
            ...
            {/* Ngày thực hiện */}
            <div className="flex items-center justify-between py-1 border-t border-gray-100">
              <span className="text-sm text-gray-500">Ngày thực hiện</span>
              <span className="text-sm font-medium text-gray-900">
      ...
      <div className="p-4 rounded-lg border border-gray-200 bg-white shadow-none hover:shadow-lg transform hover:scale-[1.01] origin-center transition-all duration-500 ease-in-out">
        ...
        <div className="space-y-2">
          {/* Được tạo bởi */}
          <div className="flex items-center justify-between py-1">
            <span className="text-sm text-gray-500">Bác sĩ xét nghiệm</span>
            <span className="text-sm font-medium text-gray-900">
              {createdBy}
            </span>
          </div>
