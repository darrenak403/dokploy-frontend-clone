...
const MainTitle = () => {
  ...
  const onOpenCreateTestOrder = disclosure?.onOpen;
  return (
      ...
      <div className="max-w-screen-xl mx-auto px-6 py-5 flex items-center justify-between gap-4">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-300">
            Quản lý đơn xét nghiệm và thông tin liên quan
          </p>
        </div>
        ...
        {role !== "ROLE_STAFF" ? (
          <Button
            type="button"
            aria-label="Add Test Order"
            onPress={() => {
              onOpenCreateTestOrder?.();
            }}
          ...
          >
            ...
            <span className="text-sm font-medium">Thêm đơn xét nghiệm</span>
          </Button>
        ) : null}
      </div>
    </div>
