        ...
        >
          ...
          >
            {timeFilteredTestOrders.map((order) => (
              <TableRow key={order.id} className="border-b border-zinc-200/50">
                <TableCell>
                ...
                <TableCell>
                  <span className="text-sm">{order.instrumentName || "-"}</span>
                </TableCell>
                <TableCell>
                  <Chip
                    ...
                    variant="flat"
                  >
                    {typeof order.priority === "string" ? order.priority : "-"}
                  </Chip>
                </TableCell>
                <TableCell>
                  <span className="text-sm">
                        ...
                        <DropdownSection>
                          ...
                          {order.status === "PENDING" ? (
                            <DropdownItem
                              ...
                              onClick={() => {
                                if (order.accessionNumber)
                                  handleSendingLabResult(order.accessionNumber);
                              }}
                            >
